...
Revision ID: 591275f6ee1e
Revises: f8b7568a4aee
Create Date: 2020-09-26 23:08:41.470398
...
revision = '591275f6ee1e'
down_revision = 'f8b7568a4aee'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('desctiption', sa.String(length=200), nullable=True),
