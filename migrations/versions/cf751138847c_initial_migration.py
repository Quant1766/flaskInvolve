...
Revision ID: cf751138847c
Revises: 
Create Date: 2020-09-26 22:48:15.414272
...
def upgrade():
    ...
    sa.Column('amount', sa.Float(precision=6), nullable=True),
    sa.Column('desctiption', sa.Text(length=500), nullable=True),
    sa.Column('shop_id', sa.Text(length=500), nullable=True),
    sa.Column('shop_order_id', sa.Text(length=500), nullable=True),
